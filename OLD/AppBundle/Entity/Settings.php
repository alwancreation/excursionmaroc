 ...
 * Settings
 * @ORM\Entity
 * @ORM\Table(name="settings", uniqueConstraints={@ORM\UniqueConstraint(name="settings_pk", columns={"setting_id"})})
 */
class Settings
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="setting_key", type="string", length=150, nullable=true)
     */
    private $settingKey;
