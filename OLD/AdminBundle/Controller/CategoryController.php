...
class CategoryController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('category_show', array('id' => $category->getCategoryId()));
        }
    ...
    public function editAction(Request $request, Category $category)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('category_edit', array('id' => $category->getCategoryId()));
        }
    ...
    private function createDeleteForm(Category $category)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('category_delete', array('id' => $category->getCategoryId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
